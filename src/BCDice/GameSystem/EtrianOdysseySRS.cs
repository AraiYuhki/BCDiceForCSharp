...
namespace BCDice.GameSystem
{
    ...
    /// 世界樹の迷宮SRS
    /// </summary>
    public sealed class EtrianOdysseySRS : GameSystemBase
    {
        public static readonly EtrianOdysseySRS Instance = new EtrianOdysseySRS();

        public override string Id => "EtrianOdysseySRS";
        public override string Name => "世界樹の迷宮SRS";
        public override string SortKey => "せかいしゆのめいきゆうSRS";
