...
namespace BCDice.GameSystem
{
    ...
    /// 少女展爛会TRPG
    /// </summary>
    public sealed class ShoujoTenrankai : GameSystemBase
    {
        /// <summary>
        /// シングルトンインスタンス
        /// </summary>
        public static readonly ShoujoTenrankai Instance = new ShoujoTenrankai();

        /// <inheritdoc/>
        public override string Id => "ShoujoTenrankai";

        /// <inheritdoc/>
        public override string Name => "少女展爛会TRPG";

        /// <inheritdoc/>
        public override string SortKey => "しようしよてんらんかいTRPG";
        ...
        {
            if (!EVENT_TABLES.TryGetValue(command, out var info))
            {
                return null;
            }
            var name = info.Name;
            var table = info.Table;
            var eventResult = GetEventTableResult(table, randomizer);
            if (eventResult == null)
            {
                return null;
            }
            var (text, number1, number2) = eventResult.Value;
            var tensionText = GetTensionText(number1, number2);
            var result = $"出来事表：{name}([{number1},{number2}]) ＞ {text}{tensionText}";
            return Result.CreateBuilder(result).Build();
        }

        private string GetTensionText(int number1, int number2)
        {
        ...
        private (string Text, int Number1, int Number2)? GetEventTableResult(string[] table, IRandomizer randomizer)
        {
            var number1 = randomizer.RollOnce(6);
            var number2 = randomizer.RollOnce(6);
            var isEven = number1 % 2 == 0;
            var index = number2 - 1;
            if (isEven)
            {
                index += 6;
        ...
        private class EventTableInfo
        {
            public string Name { get; }
            public string[] Table { get; }
            public EventTableInfo(string name, string[] table)
            {
                Name = name;
                Table = table;
            }
        ...
        private static readonly Dictionary<string, EventTableInfo> EVENT_TABLES = new Dictionary<string, EventTableInfo>
        {
            { "SPRING", new EventTableInfo("春", new[] {
            ...
            { "SUMMER", new EventTableInfo("夏", new[] {
            ...
            { "AUTUMN", new EventTableInfo("秋", new[] {
                "【奇・1】たわわに実った果物があります。",
            ...
            { "WINTER", new EventTableInfo("冬", new[] {
                "【奇・1】太陽（月）に暈がかかっています。",
                "【奇・2】風花が舞っています。",
                "【奇・3】雪が積もっています。",
            ...
            { "MORNING", new EventTableInfo("朝", new[] {
                "【奇・1】起きたら涙を流していました。",
            ...
            { "AFTERNOON", new EventTableInfo("昼下がり", new[] {
                "【奇・1】快い眠気に襲われています。",
                "【奇・2】まだ食べ足りない感じがします。",
            ...
            { "TWILIGHT", new EventTableInfo("黄昏", new[] {
            ...
            { "NIGHT", new EventTableInfo("夜中", new[] {
                "【奇・1】なかなか眠くなれません。",
            ...
            { "MIDNIGHT", new EventTableInfo("夜更け", new[] {
            ...
            { "NORBLE", new EventTableInfo("貴族趣味", new[] {
            ...
            { "MARCHEN", new EventTableInfo("メルヒェン", new[] {
            ...
            { "COLONIAL", new EventTableInfo("コロニアル", new[] {
                "【奇・1】重厚な調度が征服欲を刺激します。",
                "【奇・2】床に傷を見つけてしまいました。",
                "【奇・3】重厚な調度に頼もしさを感じます。",
            ...
            { "SHELF", new EventTableInfo("本棚のある場所", new[] {
            ...
            { "LITTLE", new EventTableInfo("小さな妹の部屋", new[] {
            ...
            { "ELDER", new EventTableInfo("素敵なお姉さまの部屋", new[] {
            ...
            { "ATERIEL", new EventTableInfo("アトリエ", new[] {
            ...
            { "OPEN", new EventTableInfo("集まれる場所", new[] {
            ...
            { "HAUNTED", new EventTableInfo("精神的瑕疵物件", new[] {
            ...
            { "SIMPLE", new EventTableInfo("侘び住まい", new[] {
                "【奇・1】若干、風通しがよすぎるようです。",
                "【奇・2】いろいろすっきりしています。",
                "【奇・3】壁のひびを見つけました。",
                "【奇・4】隅っこに穴が開いています。",
            ...
            { "LARGE", new EventTableInfo("広い場所", new[] {
            ...
            { "CORRIDOR", new EventTableInfo("廊下", new[] {
            ...
            { "STAIRS", new EventTableInfo("階段", new[] {
            ...
            { "COSY", new EventTableInfo("居心地のいい場所", new[] {
                "【奇・1】一瞬、物音が全て途絶えました。",
            ...
            { "TERRACE", new EventTableInfo("テラス・ベランダ", new[] {
                "【奇・1】木の枝や木の葉が積もっています。",
            ...
            { "GARRET", new EventTableInfo("屋根裏", new[] {
            ...
            { "KITCHEN", new EventTableInfo("台所", new[] {
            ...
            { "BATH", new EventTableInfo("浴室", new[] {
            ...
            { "REST", new EventTableInfo("化粧室", new[] {
            ...
            { "CELLER", new EventTableInfo("地下倉庫", new[] {
            ...
            { "LUMBER", new EventTableInfo("物置", new[] {
            ...
            { "GARDEN", new EventTableInfo("庭園", new[] {
            ...
            { "WASTED", new EventTableInfo("廃園", new[] {
            ...
            { "RUIN", new EventTableInfo("廃屋", new[] {
            ...
            { "SHORE", new EventTableInfo("水のほとり", new[] {
                "【奇・1】水面に波紋が広がっていきます。",
                "【奇・2】視界の外で水音がしました。",
                "【奇・3】生臭い匂いがします。",
